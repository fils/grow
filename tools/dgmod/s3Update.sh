...
mc_cmd() {
        ...
        echo "ocdmsp/ocdprod/csdco/pkg/072c62eae5913b8c9ed4e00d02595a27bd5dbec840a94a86a049deb26f55914e.jsonld"
...
# Remove addition type and add addition type to distribution
mc cat $i |  gron  > $temp2_file
echo -e  'json.distribution.encodingFormat = [];' >> $temp2_file
echo -e  'json.distribution.encodingFormat[0] = "application/zip";' >> $temp2_file
echo -e  'json.distribution.encodingFormat[1] = "https://opencoredata.org/voc/csdco/v1/Car";' >> $temp2_file
/bin/cat $temp2_file | gron -u   > $temp_file
...
# TYPE Frictionless data package   
    ...
    # Line count (for some unknown reason)
